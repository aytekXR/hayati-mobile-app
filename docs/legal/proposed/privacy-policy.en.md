...
- One of the four notifications names your partner: the one telling you they have answered today's question. It reads "Your partner Aylin answered", using the name your partner entered themselves — we do not check it, and if they entered none it says "your partner" instead. That name is the only personal detail of theirs that any notification carries. The discreet-notifications setting takes it away again: with it on, a notification says only that something is waiting for you — no name, no event, no streak count. It is on by default when your question language is Arabic, and you can switch it on in any language.
